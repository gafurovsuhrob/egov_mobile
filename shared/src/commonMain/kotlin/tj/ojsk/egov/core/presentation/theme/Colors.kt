...
val BackgroundLightColor = Color(0xFFF1F5F0)
val BackgroundDarkColor = Color(0xFF0A0F0C)
...
val SessionColor = 0xFF74B485.toInt()
val ShortBreakColor = 0xFFB2E0B2.toInt()
val LongBreakColor = 0xFF5E9C76.toInt()
